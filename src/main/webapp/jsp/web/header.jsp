...
<div class="topNavBg">
	<div class="wrap">
		...
		<ul class="topRtNav">
			...
			<li><a
				href="${pageContext.request.contextPath}/jsp/user/shoppingCart.jsp"
				class="cartIcon">购物车</a></li>
			<li><a
				href="${pageContext.request.contextPath}/jsp/user/orderFormManage/list.jsp"
				class="favorIcon">我的订单</a></li>
				<li><a
				href="${pageContext.request.contextPath}/jsp/user/main2.jsp">个人中心</a></li>
			<li><a
...
<ul class="wrap navList">
	<li class="category"><a>全部产品分类</a>
		<dl class=" commodityType asideNav indexAsideNav">
		</dl></li>
...
<script>
	$(document).ready(
			function() {
				...
				$("#chanpin").click(
						function() {
							$(".inputWrap input[type='text']").attr(
									"placeholder", "输入产品关键词或货号");
						});
				$("#shangjia").click(
						function() {
							$(".inputWrap input[type='text']").attr(
				...
				$("#zixun").click(
						function() {
							$(".inputWrap input[type='text']").attr(
									"placeholder", "输入关键词查找文章内容");
						});
				$("#wenku").click(
						function() {
							$(".inputWrap input[type='text']").attr(
									"placeholder", "输入关键词查找文库内容");
						});
			});
</script>
<script>
